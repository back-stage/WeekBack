...
개인적으로 인생에 현타가 오는 한 주였습니다. 이러는게 무슨 의미가 있는지, 단기적으로는 취업하는게 목표이지만 나는 어떤 곳에서 일하고 싶은지, 일해서 뭐가 되고 싶은건지 뭔가 구체적이고 궁극적인 목표가 없다는 느낌이 들어서 공허하더라구요. 이전에는 결말을 알 수 없고 기간도 알 수 없는 취준에 대한 불안감이었다면 이번주에 찾아온 현타는 좀 더 근본적인거 같아요. 여기에다가 좀 더 준비해서 지원해보고 싶다는 생각에 공부를 계속하고 있는데 작년과 비교해서 나는 얼마나 준비되었는가라는 생각이 더해져서 나아진게 들인 시간에 비해 있는건가 싶기도 해서 생각이 더 많아졌습니다. 그럼에도 불구하고 WEEKBACK 목표 덕분에 모든걸 내려놓지 않고 무언가를 할 수 있었던 것 같아요. WeekBack의 순기능 👍🏻
